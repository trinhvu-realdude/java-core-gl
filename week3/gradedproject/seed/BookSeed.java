...
public class BookSeed {
    ...
    // Default data Book
    Book b1 = new Book("Anna Karenina", "Leo Tolstoy", "Anna Karenina tells of the doomed love affair between the sensuous and rebellious Anna and the dashing officer, Count Vronsky. Tragedy unfolds as Anna rejects her passionless marriage and must endure the hypocrisies of society. Set against a vast and richly textured canvas of nineteenth-century Russia, the novel's seven major characters create a dynamic imbalance, playing out the contrasts of city and country life and all the variations on love and family happiness.", "Novel", 18.21, 254);
    Book b2 = new Book("Long Walk to Freedom", "Nelson Mandela", "Nelson Mandela’s autobiography contains every elements of knowledge you want to know about this legendary leader. Starting from his childhood, growing up in to a freedom fighter, to his twenty seven years in prison, and his significant role in molding up a new, democratic South Africa, this book has it all.", "Autobiography", 14.49, 263);
    Book b3 = new Book("War and Peace", "Leo Tolstoy", "Epic in scale, War and Peace delineates in graphic detail events leading up to Napoleon's invasion of Russia, and the impact of the Napoleonic era on Tsarist society, as seen through the eyes of five Russian aristocratic families.", "Novel", 12.81, 187);
    Book b4 = new Book("I Am Ozzy", "Ozzy Osbourne", "The vocal of Black Sabbath may be not have a good reputation, but, at the end of the day, he is a human being too. And this is exactly what he tells us here. There are many things to learn from this man’s experiences. This is a book written in details and humor.", "Autobiography", 5.97, 127);
